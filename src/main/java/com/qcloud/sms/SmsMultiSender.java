...
*/
        ...
        data.put("tel", SmsSenderUtil.phoneNumbersToJSONArray(nationCode, phoneNumbers));
        data.put("type", type);
        data.put("msg", msg);
        data.put("sig", SmsSenderUtil.calculateSig(appkey, random, curTime, msg, phoneNumbers));
        data.put("time", curTime);
        data.put("extend", extend);
        data.put("ext", ext);

		String wholeUrl = String.format("%s?sdkappid=%d&random=%d", url, appid, random);
        HttpURLConnection conn = SmsSenderUtil.getPostHttpConn(wholeUrl);
        ...
        if (httpRspCode == HttpURLConnection.HTTP_OK) {
            ...
            result = SmsSenderUtil.jsonToSmsMultiSenderResult(json);
        } else {
...
*/
        ...
        data.put("params", SmsSenderUtil.smsParamsToJSONArray(params));
        data.put("sig", SmsSenderUtil.calculateSigForTempl(appkey, random, curTime, phoneNumbers));
        data.put("time", curTime);
        data.put("extend", extend);
        data.put("ext", ext);        
